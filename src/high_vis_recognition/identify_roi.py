...
lower_color_green = np.array([25, 100, 100])
upper_color_green = np.array([40, 255, 255])

#TODO: Adjust in order to detect gray strips
#lower_color_green = np.array([100, 100, 100], dtype=np.uint8)
#upper_color_green = np.array([255, 255, 255],dtype=np.uint8)
